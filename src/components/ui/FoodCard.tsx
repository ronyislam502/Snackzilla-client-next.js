...
const FoodCard = ({ food }: { food: TFood }) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      whileHover={{ y: -5 }}
      className="group relative bg-[#0a0a0a]/60 backdrop-blur-3xl border border-success/20 rounded-3xl p-3 transition-all duration-500 hover:border-blue-500/40 hover:shadow-[0_0_50px_rgba(59,130,246,0.15)] overflow-hidden flex flex-col h-full"
    >
