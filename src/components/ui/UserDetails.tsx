                ...
                {isOpen && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        ...
                        <motion.div 
                            ...
                            className="relative w-full max-w-2xl bg-[#0a0a0a] rounded-[2rem] border border-white/10 shadow-[0_0_100px_rgba(0,0,0,1)] overflow-hidden"
                        >
                            {/* Decorative Elements */}
                            <div className="absolute top-0 right-0 w-64 h-64 bg-success/5 rounded-full blur-[80px] -mr-32 -mt-32 pointer-events-none" />
                            
                            <div className="relative z-10 p-8 md:p-10">
                                <div className="flex flex-col md:flex-row gap-10 items-start">
                                    {/* Avatar Column */}
                                    <div className="shrink-0 space-y-4 mx-auto md:mx-0">
                                        <div className="relative w-40 h-40 md:w-48 md:h-48 rounded-2xl overflow-hidden border border-white/10 group/avatar">
                                            <img
                                                src={user?.avatar || "/avatar.png"}
                                                alt="avatar"
                                                className="w-full h-full object-cover grayscale brightness-75 group-hover/avatar:grayscale-0 group-hover/avatar:brightness-100 group-hover/avatar:scale-105 transition-all duration-700"
                                            />
