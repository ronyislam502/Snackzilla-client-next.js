    ...
    <div className="p-4 md:p-8 space-y-8 lg:max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 bg-[#0a0a0a]/60 backdrop-blur-3xl p-6 md:p-8 rounded-3xl border border-white/5 relative overflow-hidden group">
          ...
          <div className="space-y-1 relative z-10">
              <h2 className="text-2xl md:text-3xl font-black text-white uppercase tracking-tighter italic leading-none">Security <span className="text-success">Dossier.</span></h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        >
          <div className="bg-[#0a0a0a]/40 backdrop-blur-3xl p-8 rounded-3xl border border-white/5 flex flex-col items-center text-center relative overflow-hidden group">
             ...
             <div className="relative z-10 w-40 h-40 mb-6 p-1 rounded-full border border-dashed border-success/20 group-hover:border-success/50 transition-colors duration-500">
                <div className="w-full h-full rounded-full overflow-hidden bg-neutral-900 flex items-center justify-center ring-4 ring-[#0a0a0a] shadow-2xl relative">
                    {user?.avatar ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center bg-neutral-950">
                            <UserIcon size={64} className="text-success/10" />
                        </div>
                    )}
                </div>
                <div className="absolute bottom-2 right-2 w-5 h-5 bg-success rounded-full border-4 border-[#0a0a0a] shadow-[0_0_15px_rgba(34,197,94,0.3)] anim-pulse"></div>
             </div>
             
             <div className="relative z-10">
                <h3 className="text-xl font-black text-white mb-2 tracking-tighter italic uppercase">{user?.name}</h3>
                <div className="flex items-center justify-center gap-2 text-success text-[8px] font-black uppercase tracking-[0.2em] bg-success/10 px-4 py-1.5 rounded-xl border border-success/10">
          ...
          <div className="bg-[#0a0a0a]/40 backdrop-blur-3xl p-6 rounded-3xl border border-white/5 relative overflow-hidden group">
             <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <ShieldCheckIcon size={32} className="text-success" />
             </div>
             <p className="text-[9px] text-success font-black uppercase tracking-widest mb-2 flex items-center gap-2 italic">
                <span className="w-1 h-1 rounded-full bg-success"></span>
                Security Protocol
            </p>
            <p className="text-[11px] text-gray-500 leading-relaxed font-bold italic">Preserve account integrity through persistent credential rotation and authorization vigilance.</p>
          </div>
        ...
        <motion.div
          ...
          className="lg:col-span-8 bg-[#0a0a0a]/40 backdrop-blur-3xl p-8 md:p-10 rounded-3xl border border-white/5 relative overflow-hidden h-fit"
        >
           <h3 className="text-sm font-black text-white mb-10 uppercase tracking-[0.2em] flex items-center gap-4 italic">
               Attribute Matrix
               <div className="h-px flex-1 bg-gradient-to-r from-success/20 to-transparent"></div>
           </h3>
