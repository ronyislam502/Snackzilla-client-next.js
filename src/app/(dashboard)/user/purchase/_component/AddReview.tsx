        ...
        {isOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md">
            <motion.div 
              ...
              className="w-full max-w-lg bg-[#0a0a0a]/80 backdrop-blur-3xl border border-white/5 rounded-[2rem] shadow-2xl relative overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-warning/[0.05] via-transparent to-transparent opacity-50 transition-opacity" />
              ...
              <div className="p-10 relative z-10 space-y-8">
                <div className="flex items-start justify-between">
                  ...
                  <button 
                    ...
                    className="p-2.5 bg-white/5 border border-white/5 rounded-xl text-gray-500 hover:text-white hover:bg-white/10 transition-all active:scale-90"
                  >
                    <XIcon size={16} />
                  </button>
                </div>
                ...
                <SZForm onSubmit={onSubmit}>
                  <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                        <label className="text-[8px] font-black text-gray-500 uppercase tracking-widest ml-2 italic">Culinary Commentary</label>
                        <SZTextarea 
                          name="feedback" 
