                            ...
                            <div className="relative h-32 bg-gradient-to-br from-success/10 via-success/[0.02] to-transparent flex items-center px-8 md:px-10">
                                ...
                                <div className="flex items-center gap-5 relative z-10">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-500 font-bold text-[9px] tracking-widest uppercase mt-1 italic">Content Integrity Verification</p>
                                    </div>
                                </div>
                                <button 
                                    onClick={() => setIsOpen(false)}
                                    ...
                                    <SZForm onSubmit={onSubmit}>
                                        <div className="space-y-6">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <SZInput label="Article Specification" name="title" type="text" placeholder="Update title" />
                                                <SZInput label="Index Classifiers" name="tags" type="text" placeholder="e.g. Italian, Pasta, Truffle" />
                                            </div>
                                            ...
                                            <div className="bg-white/[0.02] p-6 rounded-2xl border border-white/5 space-y-4">
                                                <div className="flex items-center justify-between">
                                                    <div className="space-y-0.5">
                                                        <h4 className="text-[10px] font-black text-white uppercase tracking-wider italic">Visual Identifier</h4>
                                                        <p className="text-[8px] text-gray-500 font-bold uppercase italic opacity-60">Highlight Asset Modification</p>
                                                    </div>
                                                    <label className="cursor-pointer group">
                                                        <div className="flex items-center gap-2 bg-white/5 hover:bg-white/10 text-white px-4 py-2 rounded-xl border border-white/5 transition-all">
                                                            ...
                                                            <span className="text-[10px] font-black uppercase tracking-widest italic">Replace Asset</span>
                                                        </div>
                                                ...
                                                {previewImage && (
                                                    <div className="relative group/img w-full h-32 rounded-xl overflow-hidden border border-white/10 shadow-2xl">
                                                        ...
                                                        <div className="absolute inset-0 bg-success/10 opacity-0 group-hover/img:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-[2px]">
                                                            <p className="text-white font-black text-[9px] uppercase tracking-[0.2em] italic">Updated Asset Context</p>
                                                        </div>
                                                    </div>
                                                )}
                                            </div>
