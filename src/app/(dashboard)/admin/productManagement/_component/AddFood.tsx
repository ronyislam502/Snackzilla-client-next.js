                                ...
                                <div className="overflow-hidden relative min-h-[500px] flex flex-col md:flex-row h-full z-10">
                                    ...
                                    <div className="w-full md:w-64 bg-black/20 border-r border-white/5 p-8 flex flex-col gap-8">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            >
                                                <PlusIcon size={16} className={activeTab === 'identity' ? 'text-black' : 'group-hover:text-success'} />
                                            ...
                                            >
                                                <PlusIcon size={16} className={activeTab === 'details' ? 'text-black' : 'group-hover:text-success'} />
                                            ...
                                            >
                                                <PlusIcon size={16} className={activeTab === 'nutrition' ? 'text-black' : 'group-hover:text-success'} />
                                        ...
                                        <div className="flex justify-between items-start mb-8">
                                            <div className="space-y-0.5">
                                                ...
                                                <h3 className="font-black text-2xl text-white tracking-tighter uppercase leading-none italic">
                                                    {activeTab === 'identity' ? 'Dish' : activeTab === 'details' ? 'Metric' : activeTab === 'nutrition' ? 'Nutrient' : activeTab === 'dietary' ? 'Class' : 'Visual'} <span className="text-success">{activeTab === 'identity' ? 'Initial' : activeTab === 'details' ? 'Matrix' : activeTab === 'nutrition' ? 'Schema' : activeTab === 'dietary' ? 'Tag' : 'Dossier'}</span>
                                                </h3>
                                            </div>
                                            <button
                                                onClick={() => setIsOpen(false)}
                                                                ...
                                                                {previewImage ? (
                                                                    <div className="relative group/img w-full h-48 rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
                                                                        ...
                                                                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/img:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm">
                                                                            <p className="text-white font-black text-[11px] uppercase tracking-[0.3em] italic">Optical Confirmation</p>
                                                                        </div>
                                                                    </div>
                                                                ) : (
                                                                    <div className="w-full h-48 rounded-2xl border-2 border-dashed border-white/5 flex flex-col items-center justify-center text-gray-600 gap-3 group-hover:border-success/20 transition-all bg-black/20">
                                                                        <CameraIcon size={48} className="opacity-10" />
                                                                        <p className="text-[9px] font-black uppercase tracking-[0.4em] opacity-40 italic">Sensor_Offline</p>
                                                                    </div>
                                                                )}
                                                            </div>
                                                        )}
